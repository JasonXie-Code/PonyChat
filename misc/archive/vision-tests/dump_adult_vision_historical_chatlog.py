"""
对同目录 adult-img-test 中每张图调用与线上一致的 run_normal_vision（force_web=False），
...
运行：在项目根目录
  $env:PYTHONPATH="P:\PonyChat"; $env:PYTHONIOENCODING="utf-8"; python misc/archive/vision-tests/dump_adult_vision_historical_chatlog.py
"""
...
TEST_SUBDIR = os.environ.get("VISION_DUMP_SUBDIR", "adult-img-test")
STAGE = os.environ.get("VISION_DUMP_STAGE", "adult_vision_run_normal")
CHAR_ID = os.environ.get("VISION_DUMP_CHAR_ID", "adult_vision_historical_dump")
USER = os.environ.get("VISION_DUMP_USER", "local_dump")
MODE = "normal"
...
async def _main() -> None:
    ...
    img_dir = os.path.join(SCRIPT_DIR, TEST_SUBDIR)
