"""Compatibility loader for `scheduled_followup` implementation modules.

The implementation lives in `scheduled_followup_impl/` and is executed into this module's
...
def _load_implementation_modules() -> None:
    impl_modules = (
        ...
        "followup_delivery.py",
    )
    impl_dir = _impl_pathlib.Path(_impl_sys._getframe().f_code.co_filename).with_name("scheduled_followup_impl")
