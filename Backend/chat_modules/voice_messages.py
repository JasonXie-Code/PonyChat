"""Compatibility loader for `voice_messages` implementation modules.

The implementation lives in `voice_messages_impl/` and is executed into this module's
...
def _load_implementation_modules() -> None:
    impl_modules = (
        "fullwidth_pair.py",
        "message_voice_synthesis.py",
    )
    impl_dir = _impl_pathlib.Path(_impl_sys._getframe().f_code.co_filename).with_name("voice_messages_impl")
