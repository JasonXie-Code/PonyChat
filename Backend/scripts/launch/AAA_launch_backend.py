"""Compatibility loader for `AAA_launch_backend` implementation modules.

The implementation lives in `AAA_launch_backend_impl/` and is executed into this module's
...
def _load_implementation_modules() -> None:
    ...
    impl_dir = _impl_pathlib.Path(_impl_sys._getframe().f_code.co_filename).with_name("AAA_launch_backend_impl")
