"""Compatibility loader for `build_demo_lyric_anchors` implementation modules.

The implementation lives in `build_demo_lyric_anchors_impl/` and is executed into this module's
...
def _load_implementation_modules() -> None:
    ...
    impl_dir = _impl_pathlib.Path(_impl_sys._getframe().f_code.co_filename).with_name("build_demo_lyric_anchors_impl")
